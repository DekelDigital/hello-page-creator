...
const FloatingCTA = () => {
  ...
  return (
    <a 
      ...
      className="fixed bottom-6 left-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl shadow-green-900/40 hover:bg-[#1ebe5d] hover:scale-110 transition-all flex items-center justify-center group"
