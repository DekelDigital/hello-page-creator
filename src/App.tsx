...
const FloatingCTA = () => {
  ...
  return (
    ...
    >
      {/* Pulsing rings */}
      <span className="absolute w-[72px] h-[72px] rounded-full bg-[#25D366]/30 animate-[wa-ping_2s_ease-out_infinite]"></span>
      <span className="absolute w-[72px] h-[72px] rounded-full bg-[#25D366]/20 animate-[wa-ping_2s_ease-out_0.6s_infinite]"></span>
      
      {/* Button */}
      <span className="relative w-[64px] h-[64px] rounded-full bg-[#25D366] shadow-2xl shadow-green-900/40 hover:bg-[#1ebe5d] hover:scale-110 transition-all flex items-center justify-center">
