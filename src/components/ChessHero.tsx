...
const ChessHero = () => {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[70vh] sm:min-h-screen flex items-start sm:items-center justify-center overflow-hidden" dir="rtl">
      {/* Background image */}
      <div
      ...
      {/* Content */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-28 pb-24 sm:pt-24 lg:pt-32 lg:pb-32">
        <motion.h1
